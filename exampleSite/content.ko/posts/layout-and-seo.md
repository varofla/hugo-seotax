...
{{< image src="https://github.com/minyeamer/minyeamer/blob/main/images/frontend/blog/seotax-16-layout-mobile-main.webp?raw=true" alt="모바일 메인" max-width="300px" >}}

**포스트 목록**이 가로 커버 이미지와 함께 단일 컬럼으로 표시

<--->

{{< image src="https://github.com/minyeamer/minyeamer/blob/main/images/frontend/blog/seotax-18-layout-mobile-menu.webp?raw=true" alt="모바일 메뉴" max-width="300px" >}}

**사이드바**가 햄버거 토글로 전체 오버레이로 열림

<--->

{{< image src="https://github.com/minyeamer/minyeamer/blob/main/images/frontend/blog/seotax-19-layout-mobile-toc.webp?raw=true" alt="모바일 목차" max-width="300px" >}}
...
params:
  images:
    rootPath: "_images"         # 크기 추출용 로컬 이미지 디렉토리
